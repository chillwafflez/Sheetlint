...
import { useCreatePreview } from "@/hooks/use-create-preview";
...
export function UploadZone() {
  ...
  const { mutate, isPending } = useCreatePreview();
  ...
  return (
    ...
    >
      ...
      <div className="drop__sub">
        Or click to browse. Max {MAX_MB} MB. We&apos;ll parse the workbook and
        show a quick preview before running the detectors.
      </div>
